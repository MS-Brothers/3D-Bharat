...
class WelcomePage(QDialog):
    ...
    def __init__(self, user_full_name="", parent=None):
        ...
        # Set window icon
        # Use the common resource_path utility
        icon_path = resource_path(os.path.join("data", "3D Bharat logo.png"))
    ...
    def set_background_image(self):
        ...
        bg_path = resource_path(os.path.join("data", "drone-image.png"))
    ...
    def keyPressEvent(self, event):
        """Handle key press events. Exit on Enter/Return."""
